...
emerge generate-pv-scenarios-for-feeder -m models/master.dss -o pvscenarios -lm 0.21 -pae 200
emerge compute-multiscenario-time-series-metrics -m models/master.dss -sf pvscenarios -o scenario_metrics_unity_pf -nc 4 -pn pvshape_july1
